...
public class SFXParlante : SFX
{
    ...
    [SerializeField] AudioClip[] _posibleAudios;

    protected override void Awake()
    {
        base.Awake();
        _audioClip = _posibleAudios[Random.Range(0,_posibleAudios.Length)];
    }
    public override void PlayMusic(AudioClip _clip1)
    {
        base.PlayMusic(_posibleAudios[Random.Range(0, _posibleAudios.Length)]);
